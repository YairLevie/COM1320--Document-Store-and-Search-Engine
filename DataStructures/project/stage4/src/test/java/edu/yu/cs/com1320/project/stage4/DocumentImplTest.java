...
public void testWordCount(){
    assertEquals(1, uriDoc1.wordCount("content")); 
    URI uri = URI.create("http://Hamlet.com");
    Document newDoc = new DocumentImpl(uri, "Sample contents contents contents contents!!!");
    assertEquals(4, newDoc.wordCount("contents")); 
}
@Test
public void testGetWords(){
    ...
    expected.add("Sample");
    expected.add("contents");
    assertEquals(expected, newDoc.getWords()); 
}
}