...
public void testSettingMetaValueWithValidUniqueUriDoc(){
    ...
    HashMap <String,String> metaDataActual = uriDoc1.getMetadata();
    HashMap <String, String> metaDataExpected = new HashMap<>();
...
public void testSettingMetaValueWithValidUniqueByteDoc(){
    ...
    HashMap <String,String> metaDataActual = byteDoc2.getMetadata();
    HashMap <String, String> metaDataExpected = new HashMap<>();
    metaDataExpected.put("Title", "Hamlet");
    metaDataExpected.put("Author", "Shakespeare");
...
public void testGetMetadata(){
    ...
    HashMap <String,String> copiedValues = byteDoc2.getMetadata();
